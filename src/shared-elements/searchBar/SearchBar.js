...
const SearchBar = ({ value, onChange, placeholder = 'Search', name, className = '', ...props }) => (
  <div className="relative">
    ...
    <input
      ...
      value={value}
      onChange={onChange}
      className={`pl-10 pr-4 py-2 bg-transparent text-gray-900 placeholder-gray-500 rounded-lg border border-gray-400 focus:outline-none focus:ring-1 focus:ring-gray-200 w-[260px] ${className}`}
      {...props}
    />
  </div>
);
