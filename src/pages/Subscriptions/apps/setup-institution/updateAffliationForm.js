...
export default function UpdateAffiliationForm({ onClose, initialData }) {
    ...
    const [form, setForm] = useState(() => {
        ...
        return {
            affiliationId: initialData?.id || "",
            affiliationType: initialData?.type || "",
            govBody: initialData?.govBody || "",
            referenceNo: initialData?.refNo || "",
            accBody: initialData?.accBody || "",
            accScore: initialData?.score || "",
            startDate: parseDate(initialData?.startDate) || null,
            endDate: parseDate(initialData?.endDate) || null,
            renewalDate: parseDate(initialData?.renewal) || null,
            programs: initialData?.programs ? (Array.isArray(initialData.programs) ? initialData.programs : [initialData.programs]) : [""]
        };
    });
    ...
    return (
        <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-4 border-b pb-3">
                <h2 className="text-base font-semibold">Edit Affiliation</h2>
                <div className="flex items-center gap-3">
                    <Button variant="cancel" size="small" className="" onClick={onClose}>Cancel</Button>
                    <Button variant="primary" size="small" className="min-w-[80px] !uppercase" onClick={handleSubmit}>Update</Button>
                </div>
            </div>
